...
class TestDot(TestCase):
    def test_simple(self):
        ...
        t.input_scalar("a2", len(array0)) # length of array
        t.input_scalar("a3", 1) # stride of array1 
        t.input_scalar("a4", 1) # stride of array2
    ...
    def test_stride(self):
        ...
        t.input_array("a1", array1)
        # load array attributes into argument registers
        t.input_scalar("a2", 3) # length of array
        t.input_scalar("a3", 1) # stride of array1
        t.input_scalar("a4", 2) # stride of array2
        # call the `dot` function
        t.call("dot")
        # check the return value
...
class TestClassify(TestCase):
    ...
    def test_simple0_input0(self):
        ...
        t.check_stout(2)
        t.check_file_output(outfile, ref_file)
